...
const mcp = createMcpServer({
  ...
  tools: [{
    ...
    app: { resourceUri: statusView.uri, visibility: ["model", "app"] },
    invoke: () => ({
      ok: true,

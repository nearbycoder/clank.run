...
const COMMANDS = Object.freeze({
  ...
  workbench: {
    usage: "clank workbench <performance|policy|flag|revision|parity|schema|capacity|upgrade|provenance|promotion|rollout|export|sanitize|provider|contract|visual> [arguments] [--json]",

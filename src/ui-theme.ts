...
const themePresets = [
  ...
  defineClankTheme({
    ...
    tokens: tokens({
      ...
      surfaceHover: "#e4eaf2", text: "#152033", textMuted: "#5a697f", textFaint: "#5f6875",
      border: "#d9e0e9", borderStrong: "#b6c0cd", accent: "#255fdb", accentHover: "#174fc7",
  ...
  defineClankTheme({
    ...
    tokens: tokens({
      ...
      surfaceHover: "#172b4b", text: "#eaf4ff", textMuted: "#8fa7c4", textFaint: "#8496ac",
  ...
  defineClankTheme({
    ...
    tokens: tokens({
      ...
      surfaceHover: "#f7dfe9", text: "#3a1d2c", textMuted: "#7c5368", textFaint: "#7b5d6c",
      border: "#efd2df", borderStrong: "#dba9bf", accent: "#b33564", accentHover: "#b92660",
  ...
  defineClankTheme({
    ...
    tokens: tokens({
      ...
      surfaceHover: "#102316", text: "#c8ffd3", textMuted: "#72bb82", textFaint: "#699272",
  ...
  defineClankTheme({
    ...
    tokens: tokens({
      ...
      surfaceHover: "#ffe6bd", text: "#332112", textMuted: "#795d44", textFaint: "#79644e",
      border: "#ead8bd", borderStrong: "#cdb38e", accent: "#ad4811", accentHover: "#b63f07",
  ...
  defineClankTheme({
    ...
    tokens: tokens({
      ...
      surfaceHover: "#dce9e6", text: "#17302f", textMuted: "#526a68", textFaint: "#586866",
      border: "#cadbd8", borderStrong: "#9fbab6", accent: "#07726e", accentHover: "#046862",
  ...
  defineClankTheme({
    ...
    tokens: tokens({
      ...
      surfaceHover: "#362049", text: "#fbf2ff", textMuted: "#bea6cb", textFaint: "#9e8baa",
  ...
  defineClankTheme({
    ...
    tokens: tokens({
      ...
      surfaceHover: "#ded3c1", text: "#322d26", textMuted: "#61594e", textFaint: "#60594f",
      border: "#d4c8b6", borderStrong: "#aa9b86", accent: "#96401e", accentHover: "#873715",
  ...
  defineClankTheme({
    ...
    tokens: tokens({
      ...
      surfaceHover: "#e4ddff", text: "#2a2140", textMuted: "#685d81", textFaint: "#655f74",
      border: "#ddd5f1", borderStrong: "#bdb0da", accent: "#b02e6a", accentHover: "#ba2065",

...
`openDockerDeploymentProviderService()` composes all three components with independently verified
capsules, durable operation/generation/fence intent, drain-before-stop, deferred background
